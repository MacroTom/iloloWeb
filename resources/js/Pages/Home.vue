...
<template>
    ...
    <main class="w-full h-full flex xl:px-36 gap-5">
        <Categorysidebar/>
        <section class="flex-1 p-3">
            <div class="hidden lg:flex justify-center gap-3">
                <div class="w-1/3 py-10 rounded-lg flex flex-col items-center justify-center gap-4 font-medium text-white bg-[#4074FB]/60 hover:bg-[#4074FB]/70 cursor-pointer">
                    <span>Want to sell</span>
                    <i class='bx bx-plus text-5xl pointer-events-none select-none'></i>
