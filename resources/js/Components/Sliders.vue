...
export default{
    components:{
        Carousel, Slide, Pagination, Navigation, Link
    },
    data(){
        return{
            images: [
...
<template>
    <section class="md:col-span-2 lg:row-span-2 shadow-md rounded-lg">
        <Carousel class="w-full h-full overflow-hidden" :itemsToShow="1" :autoplay="4000" wrapAround>
